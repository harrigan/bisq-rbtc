...
\frame{\frametitle{The Cost of Liquidity}
  ...
  \textbf{Also, a peg-out transaction currently pays approximately
    twice the fee market rate!}  }

\frame{\frametitle{The Cost of Liquidity}
  We will provide liquidtiy using Bisq. We are developing some tools
...
\frame{\frametitle{Bisq as an Alternative}
  ...
  \begin{itemize}
    \item While Bisq trades are somewhat more expensive than pegging
      in, they can be much faster.
